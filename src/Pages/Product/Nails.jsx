  ...
  return (
    <div>
      ...
      <div className="pedicure">
        ...
        <br></br>
        <span>Műköröm építés prémium + gél lakk - 18000 Ft</span>
        <br></br>
        <span>Műköröm építés XL - 20000 Ft</span>
        <br></br>
        <span>Műköröm építés extra forma - 29800 Ft</span>
        <br></br>
        <span>Műköröm újraépítés egyszínű - 22000 Ft</span>
        <br></br>
        <span>Műköröm újtaépítés prémium + gél lakk - 23000 Ft</span>
        <br></br>
        <span>Műköröm újraépítés XL - 29800 Ft</span>
        <br></br>
      ...
      <div className="pedicure">
        ...
        <br></br>
        <span>Extra díszítés - 1000 - 1500 Ft/db</span>
        <br></br>
      </div>
      <br></br> <br></br>
    </div>
