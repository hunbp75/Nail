const Manicure = () => {
  return (
    <div>
      ...
      <div className="pedicure">
        <h3>
          <u>SAJÁT KÖRÖM MEGERŐSÍTÉSE</u>
        </h3>
        <p>Ár: 10000 Ft</p>
      </div>
      <br></br>
      <h1>Géllakk szolgáltatások</h1>
      <br></br>
      <div className="pedicure">
        <h3>
        ...
        <p>
          ...
          Egyszínű erősített gél lakkozás. Gépi manikűr és az előző géllakk
          eltávolítását követően egy erősített géllakkozást készítem neked. A
          körmöd lehet egyszínű vagy minden körmöd más színű. A szolgáltatásban
          válaszd géllakk prémiumszolgáltatatásunkat.
        </p>
      </div>
      <br></br>
      <br></br>
